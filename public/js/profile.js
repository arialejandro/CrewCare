/* =============================================================================
   profile.js — Profile view (CrewCare): profile-photo cropper + upload modal.
   /profile -> PerfilController@indexb -> view('profile').

   Ported from Bootstrap 4 (jQuery .modal() API) to Bootstrap 5 — same port as
   the Home (public/js/inicio.js).
   ...
   view) — see note in profile.blade.php. Behavior identical to the original AJAX.
   Upload route URL is exposed by the view as window.uploadCropImageUrl (a .js
   file can't run Blade). On success it reloads /profile, as the original did.
   ============================================================================= */
(function () {
  var $modal = $('#modal');
