...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'locale' => \App\Http\Middleware\localization::class,
        // (2026-07-24 · PIEZA 3) Paso 0 del consentimiento. NO va en ningún grupo global: se
        // cuelga SÓLO de las rutas que recaban datos de salud (ver routes/web.php). Quien no ha
        // aceptado el aviso sigue usando la app; lo único que no puede es entregar datos
