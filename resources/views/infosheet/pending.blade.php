...
{{-- BANDEJA "POR AUTORIZAR" — el DISPARADOR de descubrimiento del autorizador: los tratos crew_work
     ...
     Aquí NO se autoriza: se descubre. La autorización se firma DENTRO de la Hoja, en la ficha de la
     persona, después de revisar la información — nunca antes y nunca en bloque. Cada fila lleva ahí. --}}
<div class="crew-page">
